...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (executando) {
            ...
            switch (opcao) {
                case 1 -> lancarSonda();
                case 2 -> listarSondas();
                case 3 -> executarMissao();
                case 4 -> recarregarSonda();
                case 5 -> exibirRelatorios();
                case 0 -> {
    ...
    private static void listarSondas() {
        ...
        for (int i = 0; i < sondas.size(); i++) {
            System.out.printf("%d. %s%n", i + 1, sondas.get(i));
        }
        System.out.println("-".repeat(80));
        System.out.printf("Total: %d sonda(s) ativa(s).%n", sondas.size());
    }
    ...
    private static void executarMissao() {
        ...
        try {
            ...
            System.out.println("[Erro] Coordenadas invalidas. Informe valores numericos inteiros.");
            return;
        }
    ...
    private static Terreno selecionarTerreno() {
        ...
        for (int i = 0; i < terrenos.length; i++) {
            String restricao = terrenos[i].isRestritoPorRodas() ? " [RESTRITO para sondas mineradoras]" : "";
            System.out.printf("  %d. %-15s (consumo x%.1f)%s%n",
                i + 1, terrenos[i].getTipoSolo(), terrenos[i].getMultiplicadorConsumo(), restricao);
        }
        System.out.print("Escolha: ");
    ...
    private static void exibirRelatorios() {
        ...
        System.out.println("=".repeat(80));
        System.out.printf("Total: %d relatorio(s) registrado(s).%n", relatorios.size());
    }
